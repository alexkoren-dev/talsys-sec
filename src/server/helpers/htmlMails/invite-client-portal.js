exports.inviteClientPortalMail = (appHost, username, infoEmail, token) => `
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <title>Invite to the Client Portal</title>
        ...
        <![endif]-->
          ...
          >
            ...
            <tr>
              ...
              >
                <p style="margin: 0;">
                  To access the client portal you should use the following URL address and credentials:
                </p>
                <br/>
                <p style="margin: 0;">
                  <strong>URL address:</strong>
                  <a href="http://${appHost}">${appHost}</a>
                </p>
                <p style="margin: 0;">
                  <strong>Email:</strong>
                  ${infoEmail}
